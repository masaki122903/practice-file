...
#インスタンス生成時に呼ばれる初期化関数をコンストラクタ(pythonでは__init__)と言うことがある


"""-------------------------------------------------------------------------------------------"""
#c言語はコンパイルするからa=intとか使う
#型ヒント
#入力と出力のデータ型を静的に宣言しておく
#boolはTrueかFalse,それらはbool型のインスタンス
...
#ただし"pythonでは"型ヒントと異なるデータ型が入出力されても文法上、構文上エラーは出ない
...
"""-------------------------------------------------------------------------------------------"""
#スコープについて
#関数で定義された変数は外では使えない，逆も同様，（参照のみ可能）
# global x 
#globalによって共通の変数として使える．がリスクもある